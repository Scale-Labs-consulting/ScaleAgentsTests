        ...
        <div className="relative z-10 flex items-center justify-center min-h-screen p-4">
          <div className="max-w-2xl w-full text-center">
            <div className="relative mx-auto w-24 h-24 mb-6">
              <div className="absolute inset-0 bg-purple-100/20 rounded-full animate-pulse"></div>
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen p-4">
        <div className="max-w-2xl w-full">
          ...
          <div className="text-center mb-8">
            <div className="relative mx-auto w-24 h-24 mb-6">
              <div className="absolute inset-0 bg-green-100/20 rounded-full animate-pulse"></div>
          ...
          <div className="bg-white/5 backdrop-blur-md rounded-2xl shadow-2xl p-8 mb-8 border border-white/10">
            <div className="space-y-6">
              <div className="flex items-center space-x-4">
                <div className="w-12 h-12 bg-green-500/30 rounded-full flex items-center justify-center border border-green-500/20">
                  <CheckCircle className="w-6 h-6 text-green-400" />
                </div>
                <div>
                  <h3 className="font-semibold text-white text-lg">Subscrição Ativada</h3>
                  <p className="text-white/70">O seu plano foi ativado e está pronto para usar</p>
                </div>
              </div>

              <div className="flex items-center space-x-4">
                <div className="w-12 h-12 bg-blue-500/30 rounded-full flex items-center justify-center border border-blue-500/20">
                  <ArrowRight className="w-6 h-6 text-blue-400" />
                </div>
                <div>
                  <h3 className="font-semibold text-white text-lg">Acesso Completo</h3>
                  <p className="text-white/70">Pode agora aceder a todas as funcionalidades premium</p>
                </div>
              </div>

              <div className="flex items-center space-x-4">
                <div className="w-12 h-12 bg-purple-500/30 rounded-full flex items-center justify-center border border-purple-500/20">
                  <Sparkles className="w-6 h-6 text-purple-400" />
                </div>
                <div>
                  <h3 className="font-semibold text-white text-lg">Comece Agora</h3>
                  <p className="text-white/70">Explore os nossos agentes de IA e otimize o seu negócio</p>
                </div>
              </div>
            </div>
          </div>
